# Credit: this file is copied and modified from the X-transformer library:
...
try:
    ...
    from ViT.attend import Attend, Intermediates
# from x_transformers.autoregressive_wrapper import AutoregressiveWrapper
# from exp_config import print
# constants
...
class LayerScale(Module):
    ...
    def forward(self, x, **kwargs):
        ...
        out, *rest = out
        return (out * gamma, *rest) # fix syntaxerror in python 3.7
...
class Attention(Module):
    def __init__(
        ...
        if gate_values:
            ...
            self.to_v_gate_activation = MySILU() if swiglu_values else F.sigmoid
...
class AttentionLayers(Module):
    def __init__(
        ...
        **kwargs
        ...
        use_adaptive_layerscale = False # paired with use_adaptive_layernorm for ada-ln-zero from DiT pape
